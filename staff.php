...
if (isset($_GET['delete']) && $_GET['delete'] == 'success') {
    ...
    echo "<script>alert('Staff member has been deleted successfully');</script>";
...
if (isset($_GET['update']) && $_GET['update'] == 'success') {
    ...
    echo "<script>alert('Staff member has been updated successfully');</script>";
    header("Location: admin_staff.php");
    exit;
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add'])) {
    ...
    $query = "INSERT INTO staff (`staff_name`, `staff_position`, `staff_image`) VALUES ('$staff_name', '$staff_position', '$image')";
    $result = mysqli_query($conn, $query);

    if ($result) {
        $_SESSION['staff_success'] = "New Staff member has been added successfully";
        echo "<script>alert('New Staff member has been added successfully');</script>";
        header("Location: admin_staff.php");
        exit;
    } else {
