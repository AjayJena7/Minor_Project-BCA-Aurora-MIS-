...
CREATE TABLE `gifts` (
  ...
  `gift_name` varchar(60) COLLATE latin1_general_ci NOT NULL,
  `gift_description` text COLLATE latin1_general_ci,
  `gift_image` varchar(40) COLLATE latin1_general_ci DEFAULT NULL,
  `gift_price` decimal(6,2) NOT NULL,
  `gift_category` varchar(60) COLLATE latin1_general_ci NOT NULL,
  PRIMARY KEY (`gift_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
--
-- Dumping data for table `gifts`
--
INSERT INTO `gifts` (`gift_name`, `gift_description`, `gift_image`, `gift_price`, `gift_category`) VALUES
('Gift 1', 'Description for Gift 1', 'gift1.jpg', '25.00', 'Category A'),
('Gift 2', 'Description for Gift 2', 'gift2.jpg', '30.00', 'Category B'),
('Gift 3', 'Description for Gift 3', 'gift3.jpg', '15.00', 'Category C');
...
--
ALTER TABLE `gifts`
  MODIFY `gift_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
